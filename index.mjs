...
//Lab Activity 1: The E-Commerce Inventory Processor
...
//Lab Activity 2: The HR Performance Auditor
...
c(getBonusEligibleEmployees(employees));
c("Array of Objects:", employees);

//Lab Activity 3: The Project Manager's Timeline
...
c(calculateProjectTotals(projectTasks));

//Lab Activity 4: The CRM Lead Scorer
const leadRecords = [
...
c("Array of Objects:", output);

//Lab Activity 5: The Configuration Manager
...
c("The final, merged configuration:", finalConfig);

//Lab Activity 6: The Database Aggregator
...
const monthlyExpenseReports = [
  ...
  { Rent: 1500, Utilities: 280, Food: 920, Travel: 250 },
  { Rent: 1500, Utilities: 295, Food: 820, Entertainment: 180 },
  { Rent: 1500, Utilities: 285, Food: 930, Travel: 220 },
  { Rent: 1500, Utilities: 285, Food: 830, Entertainment: 160 },
  { Rent: 1500, Utilities: 295, Food: 860, Travel: 270 },
  { Rent: 1500, Utilities: 300, Food: 860, Entertainment: 190 },
  { Rent: 1500, Utilities: 300, Food: 940, Travel: 300 },
];

const totals = calculateMonthlyTotals(monthlyExpenseReports);
c("Monthly Totals:", totals);
